...
package co.edu.uniandes.csw.user.master.logic.rules.test;
 ...
 * @author Jj.alarcon10
 */
public class UserMasterLogicRules implements MethodRule {
    ...
    public UserMasterLogicRules() {
      params = null;
      caseTestName = null;
    }
    public UserMasterLogicRules(String caseTestName) {
